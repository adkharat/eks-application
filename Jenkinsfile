    ...
    stages {
        ...
        stage("Image vulnerability"){
            steps{
                ...
                sh "trivy image adkharat/first_spring_boot_to_rds_1:${env.BUILD_NUMBER} > scanningbackend_1.txt"
                sh "trivy image adkharat/second_spring_boot_to_rds_1:${env.BUILD_NUMBER} > scanningbackend_2.txt"
